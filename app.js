...
function renderIntro() {
  app.append(
    ...
    createElement('p', 'ご自身が現在生活している家計に基づいて回答してください。同居している家族全員の収支を対象とします。単身赴任など別居している家族は含めません。'),
    createElement('p', '本アンケートは研究目的で実施しています。ご回答いただいた内容は本研究の分析にのみ使用し、個人が特定される形で公開・利用することはありません。')
  );
}
