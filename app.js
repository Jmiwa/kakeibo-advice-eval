...
function renderIntro() {
  app.append(
    ...
    createElement('p', '家計に関する相談文3つと、それぞれに対する3種類のアドバイス（計9件）を読み、各アドバイスの内容を評価していただきます。所要時間は15分程度です。', 'intro-text'),
    createElement('p', 'ご自身が現在生活している家計に基づいて回答してください。同居している家族全員の収支を対象とします。単身赴任など別居している家族は含めません。', 'intro-text'),
    createElement('p', '本アンケートは研究目的で実施しています。ご回答いただいた内容は本研究の分析にのみ使用し、個人が特定される形で公開・利用することはありません。', 'intro-text')
  );
}
